...
if [[ $? -ne 42 ]] ; then echo "shit" exit 1 ; fi
...
mips-linux-gnu-gcc -c test_deliverable/test_cases/MAIN.c -o sanity-check/MAIN.o
mips-linux-gnu-gcc -c test_deliverable/test_cases/MAIN_driver.c -o sanity-check/MAIN_driver.o
mips-linux-gnu-gcc -static sanity-check/MAIN.o sanity-check/MAIN_driver.o -o sanity-check/MAIN.elf

# Check that it returns 0 (it should pass with gcc)
qemu-mips sanity-check/MAIN.elf
echo $?
