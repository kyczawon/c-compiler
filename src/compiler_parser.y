...
%token T_INTEGER T_STRING T_PERIOD T_CHARACTER T_CONST T_VOLATILE T_SIGNED T_UNSIGNED T_STR

%type <expr> FACTOR STATEMENT DECLARATION FUNCTION_DECLARATION COMPOUND_STATEMENT SEQUENCE SEQUENCE_PROG FUNCTION_DEFINITION
