...
%type <expr> EMPTY CASE_COMPOUND CASE_STATEMENT INPUT_PARAMS INIT_PARAMS INIT_DEC
...
CONDITIONAL_STATEMENT
        ...
        | T_FOR T_LBRACKET INIT_DEC T_SEMI EXPR_LIST T_SEMI EXPR_LIST T_RBRACKET COMPOUND_STATEMENT { $$ = new forLoop( $3, $5, $7, $9 ); }
...
INIT_DEC
        : TYPE T_STRING T_EQUALS EXPR_LIST { $$ = new InitialisedVariableDeclaration(*$1, *$2, $4 );}
